package com.SpringMongoCollection;
...
public class UnitTest {
    ...
    public void testAddEmployee_Success() {
        ...
        employee.setDateOfJoining(Instant.now());
        ...
        verify(employeeManagerRepo).insert(employee);
    }
    ...
    public void testGetEmployee_ByYearsOfExperienceOnly() {
        ...
        employee.setManagerId(1);
        employee.setDepartment("sales");
        employee.setDateOfJoining(Instant.parse("2000-07-25T14:30:00.000Z"));
        when(employeeManagerRepo.findByDateOfJoiningBefore(any()))
    ...
    public void testGetEmployee_ByManagerIdAndYearsOfExperience() {
        ...
        when(employeeManagerRepo.findByManagerIdAndDateOfJoiningBefore(managerId,any()))
                .thenReturn(Arrays.asList(employee));
